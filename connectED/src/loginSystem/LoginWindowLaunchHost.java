...
public class LoginWindowLaunchHost extends Application {
	LoginWindowController controller;
	
	@Override
	public void start(Stage primaryStage) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("LoginWindow.fxml")); //don't necessarily need this. Can load directly instead of creating loader
